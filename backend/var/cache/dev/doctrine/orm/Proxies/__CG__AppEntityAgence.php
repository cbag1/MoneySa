...
class Agence extends \App\Entity\Agence implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Agence' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Agence' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Agence' . "\0" . 'adresse', '' . "\0" . 'App\\Entity\\Agence' . "\0" . 'telephone', 'compte', '' . "\0" . 'App\\Entity\\Agence' . "\0" . 'agent', '' . "\0" . 'App\\Entity\\Agence' . "\0" . 'isArchived'];
        }
     ...
     * {@inheritDoc}
     */
    public function setAgent(?\App\Entity\User $agent): \App\Entity\Agence
    {
     ...
     * {@inheritDoc}
     */
    public function setIsArchived(bool $isArchived): \App\Entity\Agence
    {
