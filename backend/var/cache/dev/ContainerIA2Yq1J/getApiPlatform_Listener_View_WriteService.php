...
class getApiPlatform_Listener_View_WriteService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.listener.view.write'] = new \ApiPlatform\Core\EventListener\WriteListener(new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataPersister\TraceableChainDataPersister(new \ApiPlatform\Core\DataPersister\ChainDataPersister(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\DataPersister\\AgenceDataPersister'] ?? $container->load('getAgenceDataPersisterService'));
            yield 1 => ($container->privates['App\\DataPersister\\CompteDataPersister'] ?? $container->load('getCompteDataPersisterService'));
            yield 2 => ($container->privates['App\\DataPersister\\CompteUserDataPersister'] ?? $container->load('getCompteUserDataPersisterService'));
            yield 3 => ($container->privates['App\\DataPersister\\TransactionDataPersister'] ?? $container->load('getTransactionDataPersisterService'));
            yield 4 => ($container->privates['App\\DataPersister\\UserDataPersister'] ?? $container->load('getUserDataPersisterService'));
